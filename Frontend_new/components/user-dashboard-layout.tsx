...
import { ChevronDown, Globe, LayoutDashboard, LogOut, Network, Search, Server, Settings, UserCog } from "lucide-react"
...
export function UserDashboardLayout({ children }: UserDashboardLayoutProps) {
  ...
  // 修改 switchToAdminMode 函數，移除幫助中心相關的重定向邏輯
  ...
  // 修改 navItems 數組，添加 Account Settings 選項
  const navItems = [
    {
      title: "Main Features",
      items: [
